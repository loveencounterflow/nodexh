(function() {
  'use strict';//########################################################################################################
  var CND, FS, PATH, alert, alertxxx, badge, bold, cyan, debug, echo, get_context, gold, green, grey, help, info, log, red, reverse, rpr, show_error_with_source_context, stackman, steel, urge, warn, whisper, white, yellow;
  ...
  */
  ...
  ({red, green, steel, grey, cyan, bold, gold, reverse, white, yellow, reverse, bold} = CND);

  // { isa }                   = ( new ( require 'intertype' ).Intertype() ).export()
