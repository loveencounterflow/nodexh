(function() {
  'use strict';
  var FS, GUY, PATH, _exit_handler, _get_context, alert, blue, bold, cyan, debug, echo, exit_handler, fetch_mapped_location, get_context, get_error_callsites, gold, green, grey, inspect, lime, load_source_map, log, other_path_color, own_path_color, red, reverse, rpr, show_error_with_source_context, steel, underline, white, write_to_stderr, yellow;
  ...
  ({red, green, steel, grey, cyan, bold, lime, gold, white, blue, yellow, reverse, underline, bold} = GUY.trm); // Слава Україні // Слава Україні

  //-----------------------------------------------------------------------------------------------------------
  other_path_color = function(...P) {
    return reverse(bold(red('', ...P, '')));
  };
