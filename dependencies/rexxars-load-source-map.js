...
module.exports = function readSourceMapSync (filename, cb) {
  fs.readFileSync(filename, READ_FILE_OPTS, function (err, sourceFile) {
    if (err) {
      return cb(err)
    }
    ...
    fs.readFileSync(sourceMapUrl, READ_FILE_OPTS, onMapRead)
